    ...
    ui(new Ui::MainWindow)
{
    ...
    connect(ui->actionFileExportBin, SIGNAL(triggered()), this, SLOT(exportProjectToBinary()));
    connect(ui->actionFileExportD64, SIGNAL(triggered()), this, SLOT(exportProjectToD64())   );
